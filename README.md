...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/locopy-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=11486&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/locopy-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `locopy` can be installed with:

```
conda install locopy
```

It is possible to list all of the versions of `locopy` available on your platform with:
